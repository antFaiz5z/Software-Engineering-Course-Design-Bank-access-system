...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div>
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${base_path}/staff/staff_current_deposit.jsp">活期存款</a></li>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div align="center">
                        <form class="form-horizontal ValidForm" action="currentDeposit" method="post">

                            <div class="form-group ">
                                <label class="col-sm-3 control-label">活期存款金额：</label>

                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="任意金额" name="current_deposit_amount"  datatype="n" errormsg="金额为数字"/>
                                </div>
...
<%--
<form action="currentDeposit" method="post">

    <p>输入活期存款金额：<input type="text" name="current_deposit_amount"/></p>
