...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div>
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="${base_path}/staff/staff_fixed_deposit.jsp">定期存款</a></li>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div align="center">
                        <form class="form-horizontal ValidForm" action="fixedDeposit" method="post">

                            <div class="form-group ">
                                <label class="col-sm-3 control-label">定期存款金额：</label>

                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="应大于余额" name="fixed_deposit_amount"  datatype="n" errormsg="金额为数字"/>
                                </div>
                                <div class="col-sm-5 col-sm-offset-2 Validform_checktip"></div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">定期存款类型：</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="fixed_deposit_type" id="fixed_deposit_type">
...
<form action="fixedDeposit" method="post">
    <p><input type="text" name="fixed_deposit_amount"/></p>
    <p>
        <select name="fixed_deposit_type" id="fixed_deposit_type">
            <% if (user.getInt(Constant.USER_TYPE)==0){%>
            <option value="0">半年期</option>
            <% }%>
            <option value="1">一年期</option>
